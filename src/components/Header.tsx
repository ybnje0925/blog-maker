    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 px-4 shadow-sm backdrop-blur sm:px-8">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4">
        ...
        <nav className="hidden items-center gap-4 text-xs font-bold text-slate-600 md:flex">
          ...
          <Link to="/guide" className="hover:text-blue-700">
            블로그 작성 가이드
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 px-3 py-2 text-xs font-black text-slate-600 transition hover:bg-slate-200 hover:text-slate-950 disabled:opacity-50"
            title="입력과 결과 초기화"
          >
